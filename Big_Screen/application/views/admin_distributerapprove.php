...
<?php
		if(!$distributer)
		{
			echo '<center><h1 style="font-family:Times New Roman, Times, serif;font-size:36px;color:#FF0000" >No Distributers...!!</h1></center>';
		}
		else
		{
		?>
...
<div align="center" style="margin-top:;font-size:18px;color:#000000;width:100%;height:auto;">
		<table border="5" class="table-condensed" style="background-color:#66FFFF;margin-left:4%;margin-right:3%;opacity:0.7;border:5px #FF6600 solid">
		<tr >
		...
		$status=$row->lstatus;
		?>
		<form action="<?php echo site_url('usercontroller/approvedistributeraction')?>" method="post" name="userlist">
		<tr>
